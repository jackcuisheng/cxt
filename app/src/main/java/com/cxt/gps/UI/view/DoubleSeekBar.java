...
public class DoubleSeekBar extends View {
    ...
    private static int mTextViewMarginTop = 20;   //当前滑块文字距离view顶部距离
    ...
    public DoubleSeekBar(Context context, AttributeSet attrs, int defStyle) {
        ...
        notScrollBarBg = getResources().getDrawable(R.mipmap.seek_bar, null);
        hasScrollBarBg = getResources().getDrawable(R.mipmap.seek_bar_checked, null);
        mThumbLow = getResources().getDrawable(R.mipmap.seekbar, null);
        mThumbHigh = getResources().getDrawable(R.mipmap.seekbar, null);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if(defaultScreenLow != 0) {
            mOffsetLow = formatInt(defaultScreenLow / 24 * (mDistance)) + mThumbWidth / 2;
        }
        if(defaultScreenHigh != 24) {
            mOffsetHigh = formatInt(defaultScreenHigh / 24 * (mDistance)) + mThumbWidth / 2;
        }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //当前滑块刻度
        double progressLow = formatInt((mOffsetLow - mThumbWidth / 2) * 24 / mDistance);
        double progressHigh = formatInt((mOffsetHigh - mThumbWidth / 2) * 24 / mDistance);
    ...
    public void setProgressLow(double progressLow) {
        ...
        mOffsetLow = formatInt(progressLow / 24 * (mDistance)) + mThumbWidth / 2;
        refresh();
    }
    ...
    public void setProgressHigh(double progressHigh) {
        ...
        mOffsetHigh = formatInt(progressHigh / 24 * (mDistance)) + mThumbWidth / 2;
        refresh();
    }
    ...
    public interface OnSeekBarChangeListener {
        //滑动时
        public void onProgressChanged(DoubleSeekBar seekBar, double progressLow,
                                      double progressHigh);
    }
