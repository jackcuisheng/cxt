...
public class CarControlModelImpl implements CarControlModel{
        ...
        new Thread(){
            public void run(){
                try{
                    ...
                    list = ParseJsonUtil.getControlData(response);
                    if (list != null){
    ...
    @Override
    public void cancelControl(final String msgType, final String account, final String carNum, final OnReturnStringListener onReturnStringListener) {
        new Thread(){
            public void run(){
                try{
