...
public class ComminuteActivity extends SuperActivity  implements AdapterView.OnItemClickListener {
    private static final int REQUEST_ENABLE = 111;
    // 获取到蓝牙适配器
