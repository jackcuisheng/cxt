...
import com.cxt.gps.navigate.util.ErrorInfo;
import com.cxt.gps.navigate.util.TTSController;

import java.util.ArrayList;
import java.util.List;


public class BaseActivity extends SuperActivity implements AMapNaviListener, AMapNaviViewListener {
